import bpy
from ._utils import get_distance, average_vector, mouse_raycast, get_view_type, set_active_collection
...
class KeCopyPlus(bpy.types.Operator):
    ...
    def execute(self, context):
        # SELECTION
        paste_merge = bool(context.preferences.addons[__package__].preferences.plus_merge)
        mouse_point = bool(context.preferences.addons[__package__].preferences.plus_mpoint)
...
#
def register():
    bpy.utils.register_class(KeCopyPlus)


def unregister():
    bpy.utils.unregister_class(KeCopyPlus)
