...
from .._utils import vertloops, get_face_islands, flattened
...
class KeUnbevel(Operator):
    ...
    rebevel: BoolProperty(name="Rebevel", default=False)
    keep_width: BoolProperty(name="Keep Width", default=True)
    offset: FloatProperty(name="Offset", min=0, max=100, default=0.01, subtype="DISTANCE")
    segments: IntProperty(name="Rebevel Count", min=0, max=999, soft_max=99, default=0)
    profile: FloatProperty(name="Rebevel Profile", min=0, max=1, default=0.5)
    merge_uvs: BoolProperty(default=False, name="Rebevel Merge UVs", description="You rarely want this")
