...
class KeNiceProject(Operator):
    ...
    through : BoolProperty(name="Cut Through", default=False)
    keep : BoolProperty(name="Keep Cutter Geo", default=True,
                        description="(Edit Mode) Disable to remove cutter after operation")
    keep_selected : BoolProperty(name="Keep Cutter Selected", default=True,
                                 description="(Edit Mode) Or, the result will be selected"
                                             "(Requires Keep Cutter Geo on)")
    wire : BoolProperty(name="Use All Edges",
