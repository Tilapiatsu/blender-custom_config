...
from ._utils import get_distance, get_midpoint, get_scene_unit, set_status_text, shift_list
...
class KeQuickMeasure(bpy.types.Operator):
    ...
    qm_start: bpy.props.EnumProperty(items=[
...
#
def register():
    bpy.utils.register_class(KeQuickMeasure)


def unregister():
    bpy.utils.unregister_class(KeQuickMeasure)
