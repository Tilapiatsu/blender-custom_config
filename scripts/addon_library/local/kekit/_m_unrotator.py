...
import bmesh
from ._utils import average_vector, mouse_raycast, tri_points_order, correct_normal, rotation_from_vector, \
    get_islands, set_status_text, get_view_type, unparent
...
class KeUnrotator(Operator):
    ...
    rndz: bpy.props.BoolProperty(name="Randomize Dupe Z", default=False)
