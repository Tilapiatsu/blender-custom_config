...
from ._utils import vertloops, tri_points_order, correct_normal, average_vector
...
class KeExtractAndEdit(Operator):
    ...
    expand : BoolProperty(default=False, name="Select Connected", description="Auto-selects all connected geo")
    dupe : BoolProperty(default=False, name="Duplicate", description="Duplicate selection before extraction")
...
def register():
    bpy.utils.register_class(KeExtractAndEdit)


def unregister():
    bpy.utils.unregister_class(KeExtractAndEdit)
