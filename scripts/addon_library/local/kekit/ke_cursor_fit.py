...
from ._utils import rotation_from_vector, mouse_raycast, correct_normal, average_vector, \
    tri_points_order, vertloops, flatten, get_face_islands
...
class KeCursorFitAlign(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        self.cursor_orient_set = context.preferences.addons[__package__].preferences.cursorfit
        scale_check = True
...
def register():
    bpy.utils.register_class(KeCursorFitAlign)


def unregister():
    bpy.utils.unregister_class(KeCursorFitAlign)
