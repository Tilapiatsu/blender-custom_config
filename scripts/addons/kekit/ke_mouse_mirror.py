...
class VIEW3D_OT_ke_mouse_mirror(Operator):
    ...
    bl_description = "BBox Mirror (resize) selected elements/object using global mouse pos relative to selection." ""\
                     "Active/World: EditMode=Mirror from Active-elemt. ObjectMode=World Axis mirror"\
                     "Cursor mode: Mouse pos relative to cursor (as Global offset)."
