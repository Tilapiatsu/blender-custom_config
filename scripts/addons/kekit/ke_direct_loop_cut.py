...
from .ke_utils import mouse_raycast, average_vector, get_vert_nearest_mouse
...
class MESH_OT_ke_direct_loop_cut(bpy.types.Operator):
	...
	def execute(self, context):
		...
		if ec == 1:
			...
			if get_fac and hit_face is not None or floater:
				# Get offset factor
				...
				if hit_wloc:
					...
					mouse_wpos = region_2d_to_location_3d(self.region, self.rv3d, self.mouse_pos, svco)
