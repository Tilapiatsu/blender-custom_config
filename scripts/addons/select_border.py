...
# add the operator to specials panel
def add_select_border_button(self, context):
    self.layout.operator(VIEW3D_MT_edit_mesh_selectborder.bl_idname)
    self.layout.separator()


def register():
    bpy.types.VIEW3D_MT_edit_mesh_specials.prepend(add_select_border_button)
    bpy.utils.register_class(VIEW3D_MT_edit_mesh_selectborder)
    
def unregister():
    bpy.types.VIEW3D_MT_edit_mesh_specials.remove(add_select_border_button)
    bpy.utils.unregister_class(VIEW3D_MT_edit_mesh_selectborder)
