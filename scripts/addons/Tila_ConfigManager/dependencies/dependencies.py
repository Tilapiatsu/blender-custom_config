...
class Dependencies():
    ...
    def ensure_uv_installed(module_path: Path) -> Path:
        ...
        if not uv_path.exists():
            ...
            command = r"$env:UV_INSTALL_DIR = '{}'; irm https://astral.sh/uv/install.ps1 | iex".format(str(install_path))
    ...
    def check(*, force=False):
        ...
        if site_package_path.exists():
            try:
                ...
                ws = pkg_resources.WorkingSet(entries=[ os.fspath(site_package_path) ])
