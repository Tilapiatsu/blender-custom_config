...
class TILA_Config_Keymaps_Global(TILA_Config_Keymaps):
    ...
    def set_keymaps(self):
        ...
        self.kmi_set_replace('brush.tila_brush_toggle', self.k_menu, 'PRESS', alt=True, properties={'relative_asset_identifier': 'Saved\Brushes\Tila Snake Hook.asset.blend\Brush\Tila Snake Hook', 'asset_library_type': 'CUSTOM', 'asset_library_identifier':'Tilapiatsu'})
