...
def refresh_draw_buffers():
    ...
    edge_col = [(g_wire_edit_color.r, g_wire_edit_color.g, g_wire_edit_color.b,
                 xray_props.edge_opacity*0.7) for _ in range(vert_count)]
    ...
    for i,vert in enumerate(mesh.vertices):
        if vert.select:
            edge_col[i] = (highlight_color[0], highlight_color[1], highlight_color[2], xray_props.edge_opacity*0.7)
